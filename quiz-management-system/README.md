...
│   │   │   │   ├── StudentsPage.jsx
│   │   │   │   ├── ResultsPage.jsx
│   │   │   │   └── AttemptDetailPage.jsx
│   │   │   └── student/
│   │   │       ├── StudentLoginPage.jsx
│   │   │       ├── QuizInstructionsPage.jsx
│   │   │       └── QuizEnginePage.jsx
│   │   ├── layouts/
│   │   │   └── AdminLayout.jsx
│   │   ├── services/
...
## 🔑 Security Highlights
1. **Authoritative Backend**: Timer, attempt state, single-attempt limits, authorization, and score calculations are strictly enforced by Express endpoints.
2. **Password Hashing**: Plaintext passwords are never stored in MongoDB.
3. **No Leak Policy**: Correct answers and score calculations are completely omitted from Student endpoints.
